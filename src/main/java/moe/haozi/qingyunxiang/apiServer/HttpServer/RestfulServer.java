...
public class RestfulServer {
    public RestfulServer(org.bukkit.Server bukkit,ClassLoader classLoader) throws IOException, Exception {
        ...
        Router.RegisterParameternnotation(moe.haozi.qingyunxiang.apiServer.Annotations.Server.class, "");
        Router.RegisterRoute( "moe.haozi.qingyunxiang.apiServer", classLoader, bukkit);
